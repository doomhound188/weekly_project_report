"""
Google Gemini AI integration for summarizing time entries.
"""
...
class GeminiSummarizer:
    """Summarizes time entries using Google Gemini AI."""
    ...
    def summarize_entries(self, grouped_entries: dict[str, list[dict]], report_date: str) -> str:
        """
        Summarize grouped time entries into a formatted report.
        
        Args:
            grouped_entries: Dictionary mapping project names to their time entries
            report_date: The report date string (e.g., "2026-01-16")
